...
class InputSettings(BaseModel):
    ...
    run_airport_model: bool
    run_supplemental_trips: bool
    run_daysim: bool
    run_daysim_popsampler: bool
    run_summaries: bool
    ...
    ##############################
    num_enplanements: int
    connecting: int

    ##############################
    # Household Sampling Controls
    ##############################
    households_persons_file: str
    zone_district_file: str
    taz_sample_rate_file: str
    sampling_option: int
    pop_sample_district: dict
...
class EmmeSettings(BaseModel):
    ...
    HIGH_PNR: int
    SEATAC: int
    AIRPORT_EMP_PARKING_LOT: int
    EXTERNALS_DONT_GROW: list

    #################################
    # DaySim Airport Trip
    #################################
    PARKING_SAMPLE_SEED: int
    PARKING_ZONE_SAMPLE_RATE: float

    #################################
    # Airport Model Settings
    #################################
    airport_output_dir: str
...
class NetworkSettings(BaseModel):
    ...
    #################################
    # Employee Shuttle Settings
    #################################
    emp_shuttle_lines: list
